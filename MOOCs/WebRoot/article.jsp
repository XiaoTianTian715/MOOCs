...
<tbody><tr valign="top"><td width="98%">欢迎[用户]:<font color=blue><%=user.getUsernick()%> </font><br></td>
      </tr>
    </tbody>
  </table>
    ...
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        ...
        <td width="1%" class="jive-icon"><a href="userpost.jsp"><img src="images/post-16x16.gif" alt="发表新主题" border="0" height="16" width="16"></a></td>
          <td  width="5%"class="jive-icon-label"><a id="jive-post-thread" href="userpost.jsp">发表新主题</a> </td>
             <td  width="80%"class="jive-icon-label"><a id="jive-post-thread" href="articleSearch.jsp">搜索帖子</a> </td>
    ...
    <tbody>
      <tr valign="top">
        <td><span class="nobreak">  
          ...
          <a href="article.jsp?pageNo=1">第一页</a></span></span>
          
          
          
          <span class="nobreak"><span class="jive-paginator">|</span></span>
          <span class="nobreak"><span class="jive-paginator">
          <a href="article.jsp?pageNo=<%=pageNo - 1 %>">上一页</a>
          </span></span>
          
         <span class="nobreak"><span class="jive-paginator">| </span></span>
         <span class="nobreak"><span class="jive-paginator">
         <a href="article.jsp?pageNo=<%=pageNo + 1 %>">下一页</a>
          |&nbsp; 
          <a href="article.jsp?pageNo=<%=totalPages %>">最末页</a> ] </span> </span> </td>
      </tr>
    </tbody>
  </table>
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
