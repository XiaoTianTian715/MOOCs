                      ...
                      <tr id="jive-message-780144" class="jive-odd" valign="top">
                            ...
                            <tbody>
                              <tr>
                                <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                  ...
                                  <br>
                                  <span class="jive-description"> 发表人：
                                  <%=a.getWriter() %> <br>
                        ...
                        <td class="jive-last" width="99%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          ...
                                          <td class="jive-icon-label"><a href="reply.jsp?id=<%=a.getId() %>&rootId=<%=a.getRootId() %>" title="回复本主题">回复本主题</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div></td>
                              ...
                              <tr>
                                <td colspan="4" style="border-top: 1px solid rgb(204, 204, 204); font-size: 9pt; table-layout: fixed;"><br> <a href=""><font color="#666666"></font></a> </td>
                              </tr>
                            </tbody>
                          </table></td>
                      </tr>
