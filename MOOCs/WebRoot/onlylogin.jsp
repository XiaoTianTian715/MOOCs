...
//alert("document.getElementById(" divMsg ").innerHTML="<%=request.getAttribute("message ")%>";");
</script>
...
<div   align=center>
 ...
 <INPUT  type="radio" checked="checked" value="User" name="posi"><font size=3>学生</font> <INPUT   type="radio" value="Teacher" name="posi"><font  size=3>教师</font>
  </div>            
 
<P style="padding: 30px 0px 10px; position: relative;"><SPAN 
class="u_logo"></SPAN>         <INPUT class="ipt" id="loginName" name="loginName" type="text" placeholder="请输入用户名" value=""> 
    </P>
...
href="javascript:void(0);" onclick="onreset1();">重置</A></SPAN> 
...
href="javascript:void(0);" onclick="onsubmit1();">登录</A> 
           </SPAN>         </P></DIV>
</DIV>
		   <div align="center" id="divMsg" style="color:red; font-size:12px;"style="text-align:center;">
<p></p>
</div>
</form>
</BODY></HTML>
