...
<tbody><tr valign="top"><td width="98%">欢迎[管理员]:<font color=blue><%=teacher.getAdminnick()%></font><br></td>
      </tr>
    </tbody>
  </table>
                    ...
                    <%
                    	...
                    	//System.out.println(request.getRequestURL());
                    	 %>
                    	   ...
                    	   <a href="delete.jsp?id=<%=a.getId()%>&isLeaf=<%=a.isLeaf()%>&pid=<%=a.getPid() %>&from=<%=url %>"  onClick="return confirm('真的要删除?')">DEL</a>
                    </td>
                    <td class="jive-thread-name" width="20%"><a id="jive-thread-1" href="articleDetailFlat.jsp?id=<%=a.getId() %>"><%=a.getTitle() %></a></td>
                    <td class="jive-msg-count"width="50%"><span class=""> <%=a.getCont() %> </span></td>
                   <td class="jive-author" nowrap="nowrap"  width="8%"> <span class=""> <%=a.getWriter() %></span></td>
